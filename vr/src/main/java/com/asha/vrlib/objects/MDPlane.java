...
import com.asha.vr.strategy.projection.PlaneProjection;
...
public class MDPlane extends MDAbsObject3D {
    ...
    public MDPlane(RectF size) {
        this(new PlaneProjection.PlaneScaleCalculator(MDvrrary.PROJECTION_MODE_PLANE_FULL,new RectF(0,0,100,100)),size);
    }
