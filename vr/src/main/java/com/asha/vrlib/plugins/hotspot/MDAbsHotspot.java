...
import com.asha.vr.MD360Program;
...
import static com.asha.vr.common.GLUtil.glCheck;
...
public abstract class MDAbsHotspot extends MDAbsPlugin implements IMDHotspot {
    ...
    private MDvrrary.ITouchPickListener clickListener;
    ...
    protected void initInGL(Context context) {
        program = new MD360Program(MDvrrary.ContentType.BITMAP);
