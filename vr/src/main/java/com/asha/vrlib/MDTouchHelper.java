...
public class MDTouchHelper {
    ...
    private MDvrrary.IAdvanceGestureListener mAdvanceGestureListener;
    private List<MDvrrary.IGestureListener> mClickListeners = new LinkedList<>();
    ...
    public MDTouchHelper(Context context) {
        mGestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                ...
                for (MDvrrary.IGestureListener listener : mClickListeners){
                    listener.onClick(e);
                }
                return true;
            }
    ...
    public void addClickListener(MDvrrary.IGestureListener gestureListener) {
        if (gestureListener != null) mClickListeners.add(gestureListener);
    }

    public void setAdvanceGestureListener(MDvrrary.IAdvanceGestureListener listener) {
