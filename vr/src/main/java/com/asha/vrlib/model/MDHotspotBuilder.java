...
import com.asha.vr.common.MDUtil;
...
public class MDHotspotBuilder {
    ...
    public MDvrrary.IImageLoadProvider imageLoadProvider;

    public static MDHotspotBuilder create(MDvrrary.IImageLoadProvider imageLoadProvider){
        return new MDHotspotBuilder(imageLoadProvider);
    }

    public MDHotspotBuilder(MDvrrary.IImageLoadProvider imageLoadProvider) {
    ...
    public MDHotspotBuilder listenClick(MDvrrary.ITouchPickListener listener) {
