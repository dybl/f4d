...
import com.asha.vr.common.MDMainHandler;
import com.asha.vr.compact.CompactEyePickAdapter;
import com.asha.vr.compact.CompactTouchPickAdapter;
import com.asha.vr.model.BarrelDistortionConfig;
import com.asha.vr.model.MDDirectorBrief;
import com.asha.vr.model.MDHitEvent;
import com.asha.vr.model.MDMainPluginBuilder;
import com.asha.vr.model.MDPinchConfig;
import com.asha.vr.model.MDRay;
import com.asha.vr.plugins.hotspot.IMDHotspot;
import com.asha.vr.plugins.MDAbsPlugin;
import com.asha.vr.plugins.MDPluginManager;
import com.asha.vr.plugins.hotspot.MDAbsView;
import com.asha.vr.strategy.display.DisplayModeManager;
import com.asha.vr.strategy.interactive.InteractiveModeManager;
import com.asha.vr.strategy.projection.IMDProjectionFactory;
import com.asha.vr.strategy.projection.ProjectionModeManager;
import com.asha.vr.texture.MD360BitmapTexture;
import com.asha.vr.texture.MD360Texture;
import com.asha.vr.texture.MD360VideoTexture;
import com.google.android.apps.muzei.render.GLTextureView;

import java.util.Iterator;
import java.util.List;

import static com.asha.vr.common.VRUtil.notNull;

/**
 * Created by hzqiujiadi on 16/3/12.
 * hzqiujiadi ashqalcn@gmail.com
 */
public class MDvrrary {

    private static final String TAG = "MDvrrary";
    ...
    private MDvrrary(Builder builder) {
    ...
    public static class Builder {
         ...
         * @return vr lib
         */
        public MDvrrary build(int glViewId){
        ...
        public MDvrrary build(GLSurfaceView glSurfaceView){
            return build(MDGLScreenWrapper.wrap(glSurfaceView));
        }

        public MDvrrary build(GLTextureView glTextureView){
            return build(MDGLScreenWrapper.wrap(glTextureView));
        }

        private MDvrrary build(MDGLScreenWrapper screenWrapper){
