...
import static com.asha.vr.common.GLUtil.compileShader;
import static com.asha.vr.common.GLUtil.createAndLinkProgram;
import static com.asha.vr.common.GLUtil.readTextFileFromRaw;
...
public class MD360Program {
    ...
    private static class FragmentShaderFactory {
        ...
        static String fs(Context context, int type){
            int resId;
            switch (type){
                case MDvrrary.ContentType.BITMAP:
                    resId = R.raw.per_pixel_fragment_shader_bitmap;
                    break;
                case MDvrrary.ContentType.FBO:
                    resId = R.raw.per_pixel_fragment_shader_bitmap_fbo;
                    break;
                case MDvrrary.ContentType.VIDEO:
                default:
