...
import com.asha.vr.common.VRUtil;
import com.asha.vr.model.MDDirectorSnapshot;
...
import static com.asha.vr.common.VRUtil.checkMainThread;
...
public class MDPickerManager {
    ...
    private MDvrrary.IEyePickListener2 mEyePickChangedListener;

    private MDvrrary.ITouchPickListener2 mTouchPickListener;
    ...
    private MDvrrary.IGestureListener mTouchPicker = new MDvrrary.IGestureListener() {
        @Override
    ...
    public MDvrrary.IGestureListener getTouchPicker() {
        return mTouchPicker;
    }
    ...
    public void setEyePickChangedListener(MDvrrary.IEyePickListener2 eyePickChangedListener) {
        this.mEyePickChangedListener = eyePickChangedListener;
    }

    public void setTouchPickListener(MDvrrary.ITouchPickListener2 touchPickListener) {
