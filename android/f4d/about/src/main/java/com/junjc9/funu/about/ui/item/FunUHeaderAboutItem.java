...
public final class FunUHeaderAboutItem extends FunUAboutItem {

    private FunUHeaderAboutItem(FunUHeaderAboutItem.Builder builder) {
    ...
    public static class Builder {
        ...
        public FunUHeaderAboutItem build() {
            return new FunUHeaderAboutItem(this);
        }
