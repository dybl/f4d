...
public final class FunUAuthorAboutItem extends FunUAboutItem {

    private FunUAuthorAboutItem(FunUAuthorAboutItem.Builder builder) {
    ...
    public static class Builder {
        ...
        public FunUAuthorAboutItem build() {
            return new FunUAuthorAboutItem(this);
        }
